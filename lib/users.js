...
* @param {Mixed} data - Passed data upon success.
*/
...
var users = {
    ...
    /**
     * Retrieve the current open socket ID for a given user.
     * @param {User} user - The user instance to lookup.
    ...
    /**
     * Update the current open socket ID for a given user.
     * @param {User} user - The user instance to lookup.
    ...
    /**
     * Retrieve the playlist for a given user.
     * @param {User} user - The user instance to lookup.
     * @param {FailCallback} failure
     * @param {SuccessCallback} success
     */
    ...
    /**
     * Update the playlist object for a given user.
     * @param {User} user - The user instance to lookup.
     * @param {Object} playlist - The new playlist.
     */
